...
### -Content
Comma-separated content types to support.
...
### -Disable
Create the storage in disabled state.
...
### -Nodes
Limit access to these nodes (comma-separated).
...
### -Path
Base directory path (for dir type).
...
### -Shared
Storage is shared across cluster nodes.
...
Parameter Sets: (All)
Aliases:
Accepted values: dir, nfs, lvm, lvmthin, zfspool, zfs, cephfs, rbd, iscsi, iscsidirect, glusterfs, cifs, pbs
...
### PSProxmoxVE.Core.Models.Storage.PveStorage
## NOTES
