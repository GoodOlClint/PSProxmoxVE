...
New-PveNetwork [-Node] <String> [-Iface] <String> [-Type] <String> [-Address <String>] [-Netmask <String>]
 [-Gateway <String>] [-BridgePorts <String>] [-BondSlaves <String>] [-VlanId <Int32>] [-Mtu <Int32>]
...
### -Autostart
Start interface automatically at boot.
...
### -Comments
Comments or notes for this interface.
...
Parameter Sets: (All)
Aliases:
Accepted values: bridge, bond, eth, alias, vlan, OVSBridge, OVSBond, OVSPort, OVSIntPort
