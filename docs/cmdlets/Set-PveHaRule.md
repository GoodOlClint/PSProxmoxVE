...
```
Set-PveHaRule [-Rule] <String> [-Type] <String> [-State <String>] [-Comment <String>] [-Properties <Hashtable>]
...
### -Type
HA rule type (as defined in PVE, e.g.
node-affinity, resource-affinity, location, colocation).
